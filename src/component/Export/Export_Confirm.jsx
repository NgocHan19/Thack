  ...
  return (
    <div className="relative w-full h-[1080px] bg-[#F4F7FA]">
      ...
      <button className="absolute left-[230px] top-[20px] font-inter font-bold text-sm leading-[29px] text-[#7D7D7D]"
        onClick={() => handleNavigate('/xacnhaxuatkho')}>Xác nhận xuất kho</button>
    <div> 
      <div className="relative w-full h-full bg-gray-200">
        ...
        <div className='absolute w-[800px] h-[40px]'>
          <div className="absolute left-[20px] top-[10px] w-[350px] h-[31px] text-xl leading-[31px] font-bold text-black">
            Xác nhận thông tin xuất lô hàng
          </div>
        </div>
          ...
          <button onClick={() => handleNavigate('/xacnhanxuatkho')} className="absolute right-[20px] bottom-[20px] w-[200px] h-[35px] bg-[#64C860] rounded-[10px] flex items-center justify-center">
            <img src={images['icon_tick_white.png']} alt="Nhập kho" className="w-[20px] h-[20px] mr-2" /> 
            <span className="font-inter font-semibold text-white text-base leading-[22px]">Xác nhận xuất kho</span>
            </button>

            <button className="absolute right-[240px] bottom-[20px] w-[100px] h-[35px] bg-[#3498DB] rounded-[10px] flex items-center justify-center"
            onClick={() => handleNavigate('/xuatkho')}>
