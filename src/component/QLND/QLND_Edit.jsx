    ...
    return (
        <div className="relative w-full h-[1080px] bg-[#F4F7FA]">
            <button onClick={() => handleNavigate('/qlnd')}
                ...
                Quản lý người dùng/
            </button>            <button className="absolute left-[235px] top-[20px] font-inter font-bold text-base leading-[29px] text-[#7D7D7D]">Chỉnh sửa thông tin nhân viên</button>
            <div className="absolute w-[1150px] h-[750px] left-[50px] top-[60px] bg-white rounded-[15px] shadow-lg">
                <div className="absolute left-[40px] top-[15px] flex items-center">
                    ...
                    <h2 className="text-[24px] font-bold text-black">Chỉnh sửa thông tin người dùng</h2>
                </div>
