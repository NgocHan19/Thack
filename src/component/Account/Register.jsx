...
const Register = () => {
  ...
  return (
    <div className="relative w-full h-[1080px] bg-white">
      ...
      {/* Họ và tên */}
      <label htmlFor="fullName" className="absolute left-[154px] top-[200px] text-[#868585] font-normal text-xl leading-[29px]">
        Họ và tên
      </label>
      ...
      {/* Email */}
      <label htmlFor="email" className="absolute left-[154px] top-[340px] text-[#868585] font-normal text-xl leading-[29px]">
        Email
      </label>
      ...
      {/* Mật khẩu */}
      <label htmlFor="password" className="absolute left-[154px] top-[480px] text-[#868585] font-normal text-xl leading-[29px]">
        Mật khẩu
      </label>
      ...
      {/* Xác nhận mật khẩu */}
      <label htmlFor="confirmPassword" className="absolute left-[154px] top-[620px] text-[#868585] font-normal text-xl leading-[29px]">
        Nhập lại mật khẩu
      </label>
