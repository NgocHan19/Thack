...
function Login() {
  ...
  return (
    <div className="relative w-full h-auto">
      ...
      {/* Đăng nhập button */}
      <div className="absolute left-[400px] top-[430px] w-[827px] h-[60px] bg-[#3498DB] rounded-[5px] flex items-center justify-center">
        <span className="text-[#FFFBFB] text-[24px] font-bold">Đăng nhập</span>
      </div>

      {/* Đăng nhập bằng Gmail button */}
      <div className="absolute left-[400px] top-[510px] w-[827px] h-[60px] bg-[#DB4437] rounded-[5px] flex items-center justify-center cursor-pointer transition duration-200 hover:bg-[#c13528]">
        <span className="text-[#FFFFFF] text-[24px] font-bold">Đăng nhập bằng Gmail</span>
      </div>

      {/* Đăng ký */}
      <button className="absolute left-[600px] top-[590px] flex items-center"
        onClick={() => navigate('/dangky')}>
        <span className="text-[#A2A2A2] text-[20px] font-normal">Bạn chưa có tài khoản? Đăng ký ngay</span>
      </button>
      
      <div className="absolute left-[500px] top-[630px] w-[630px] border-b border-[#A2A2A2]"></div>

      <div className="absolute left-[600px] top-[650px]">
        <p className="text-[#5E5D5D] text-[20px] font-bold">Bạn gặp khó khăn khi tạo tài khoản?</p>
      </div>

      <div className="absolute left-[560px] top-[680px]">
