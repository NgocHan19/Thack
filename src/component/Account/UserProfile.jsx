  ...
  return (
    <div className="relative w-full h-[1080px] bg-[#EEEEEE]">
      ...
      <div className="absolute w-[1070px] h-[750px] left-[50px] top-[80px] bg-white rounded-[15px]"> 
        ...
        <div className="absolute w-[264px] h-[39px] left-[100px] top-[30px] font-inter font-bold text-[32px] leading-[39px] text-black">
          Tài khoản của tôi
        </div>
        <button className="absolute right-[30px] top-[30px]">
          <img src={images['icon_edit.png']} alt="Edit" className="w-[30px] h-[30px]" />
        </button>

        <div className="absolute left-[180px] top-[100px] flex items-center">
          <button className="w-full h-full">
            <img src={images['icon_account.png']} alt="Icon" className="w-[80px] h-[80px]" />
          </button>
        ...
        <div className="absolute left-[80px] top-[250px]">
          <div className="w-[110px] h-[29px] font-inter font-bold text-[24px] leading-[29px] text-[#A09696]">
            Họ và tên
          </div>
        ...
        <div className="absolute left-[80px] top-[380px]">
          <div className="w-[200px] h-[29px] font-inter font-bold text-[24px] leading-[29px] text-[#A09696]">
            Ngày tạo hồ sơ
          </div>
        ...
        <button className="absolute w-[120px] h-[50px] right-[40px] bottom-[30px] bg-[#64C860] rounded-[15px] flex items-center justify-center">
          <img src={images['icon_save.png']} alt="Icon" className="w-[25px] h-[25px] mr-2" />
          <div className="font-inter font-medium text-[24px] leading-[29px] text-white">
            Lưu
          </div>
        </button>
      </div>
