...
function Chinhanh_Tao() {
  ...
  return (
    <div className="relative w-full h-[1080px] bg-[#F4F7FA]">
       ...
       <div className="absolute left-[70px] top-[20px] font-inter font-bold text-base leading-[29px] text-[#7D7D7D]" onClick={() => navigate('/chinhanh')}>Chi nhánh/Tạo mới</div>
...
<div className="absolute w-[380px] h-[35px] left-[100px] top-[319px] bg-white rounded-[10px] border border-[#525050] flex items-center">
  ...
  <div className="left-[150px] top-[84px] absolute text-[24px] font-bold text-black">Tạo Chi nhánh mới</div>
