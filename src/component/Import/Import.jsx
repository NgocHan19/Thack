...
const Import = () => {
  ...
  return (
    <div className="relative w-full h-[1080px] bg-[#EEEEEE]">
      ...
      <button className="absolute left-[180px] top-[20px] font-inter font-bold text-base leading-[29px] text-[#7D7D7D]">Nhập kho</button>
    ...
    <div> 
      <div className="absolute w-[1130px] h-[570px] left-[50px] top-[60px] bg-white rounded-lg">
        ...
        <div className="absolute left-[260px] top-[185px]">
          ...
          <input type="date" placeholder='Chọn ngày sản xuất...' className="box-border w-[200px] h-[30px] mt-[15px] bg-white border border-[#525050] rounded-[10px] pl-2 pr-2" />
        </div>
