...
<div className="absolute w-[380px] h-[35px] left-[399px] top-[221px]">
  ...
  <div className="left-[396px] top-[480px] absolute text-[#a09696] text-2xl font-bold font-['Inter']">Contact</div>
...
<div className="absolute w-[380px] h-[35px] left-[398px] top-[319px]">
  ...
  <img className="w-[450px] h-[590px] left-[1380px] top-[219px] absolute" src="https://via.placeholder.com/450x590" />
  <img className="w-[50px] h-[50px] left-[371px] top-[78px] absolute" src={images['iconttncc.png']} />
  
  <div className="left-[438px] top-[80px] absolute text-black text-[32px] font-bold font-['Inter']">Chỉnh Sửa Thông Tin Nhà Cung Cấp</div>
</div>
);
}
