...
function Nhacungcap_Sua() {
  ...
  <div className="absolute w-[300px] h-[35px] left-[70px] top-[319px]">
    ...
    <div className="left-[430px] top-[875px] absolute text-white text-xl font-bold font-['Inter']" onClick={handleClick}>Lưu thay đổi</div>
  {showSuccessMessage && (
    ...
    <div className="left-[150px] top-[84px] absolute text-black text-[32px] font-bold font-['Inter']">Chỉnh sửa thông tin nhà cung cấp</div>
  </div>
  );
  }
