...
<div className="left-[100px] top-[207px] absolute text-base text-[#3498DB]">Tổng số danh mục:</div>
  ...
  <div className="w-[184px] h-[50px] left-[950px] top-[150px] absolute">
    <div className="w-[165px] h-[40px] left-0 top-0 absolute bg-[#3498db] rounded-[15px]" />
    <div className="w-[126px] h-[21px] left-[43px] top-[10px] absolute text-white font-semibold text-base"onClick={() => navigate('/danhmuc-ql-tao')}>Tạo danh mục</div>
  </div>
