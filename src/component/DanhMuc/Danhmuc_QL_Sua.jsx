...
function Danhmuc_QL_Sua() {
  ...
  return (
    <div className="relative w-full h-[1080px] bg-[#F4F7FA]">
      ...
      <div className="absolute left-[70px] top-[20px] font-inter font-bold text-base leading-[29px] text-[#7D7D7D]" onClick={() => navigate('/danhmuc-ql')}>Kho Linh Kiện/Chỉnh Sửa</div>
      <div className="left-[150px] top-[84px] absolute text-[24px] font-bold text-black">Chỉnh Sửa Thông Tin Danh Mục</div>
