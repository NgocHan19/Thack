...
function DSLK2() {
  ...
  <div className="absolute left-[70px] top-[20px] font-inter font-bold text-base leading-[29px] text-[#7D7D7D]" onClick={() => navigate('/dslk')}>Kho Linh Kiện/ Chi Tiết Linh Kiện</div>
  ...
  <div className="left-[100px] top-[208px] absolute text-base text-[#3498DB]">Tên lô:</div>
  <div className="left-[500px] top-[208px] absolute text-base text-[#3498DB]">Tên linh kiện:</div>
  
  <div className="w-[1150px] h-[284px] left-[50px] top-[299px] absolute">
    <div className="left-[250px] top-[4px] absolute text-black text-xs font-normal font-['Inter']">Số seri</div>
    <div className="left-[370px] top-[4px] absolute text-black text-xs font-normal font-['Inter']">Ngày sản xuất</div>
    ...
    <div className="left-[555px] top-[4px] absolute text-black text-xs font-normal font-['Inter']">Thời gian sử dụng</div>
    <div className="w-[25px] h-[0px] left-[750px] top-[25px] absolute origin-top-left -rotate-90 border-2 border-[#cdcdcd]"></div>
    <div className="left-[800px] top-[4px] absolute text-black text-xs font-normal font-['Inter']">Ngày hết hạn</div>
    <div className="w-[25px] h-[0px] left-[920px] top-[25px] absolute origin-top-left -rotate-90 border-2 border-[#cdcdcd]"></div>
    <div className="left-[1000px] top-[4px] absolute text-black text-xs font-normal font-['Inter']">Mô tả</div>
